...
/*   Updated: 2024/11/11 11:42:12 by marieke          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	transform.translation = translation_matrix(0, 0, 20);
	...
	//world.lights = NULL;
	add_light_to_list(&world.lights, new_light(create_point(-40, 0, 30), new_color(1, 1, 1), 1));
